...
require_once  'Ccsd/Search/Solr/Indexer/RefSite.php';
/**
 ...
 *
 */
class Hal_Search_Solr_Indexer_RefsiteCore extends  Ccsd_Search_Solr_Indexer_Core
{
    /** @var string  */
    public static $indexerClass =  'Ccsd_Search_Solr_Indexer_RefSite';
}
Ccsd_Search_Solr_Indexer_Core::registerCore('Hal_Search_Solr_Indexer_RefsiteCore');